...
if(isset($_GET['id'])){
       ...
       //e salvar na variavel $objProduto;
       //Para usar o DAO eu preciso importar ele
    require_once $_SERVER['DOCUMENT_ROOT'].'/aulaphp/bolateria/model/dao/ProdutoDAO.php';
    //usar o meu getByid da classe produto dao e armazenar o restorno
    //na variável $objProduto
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                               <form action="../control/produto.php"  method="Post">
                                   ...
                                   Preço/kg: <input type="number" step="0.010" id="precokg" name="precokg" value="<?php echo ($objProduto==NULL?"":$objProduto->getPrecoKg());?>"> <br>
